classdef histo < handle
  ...
  %     histo.N       : number of samples
  %     histo.samples : vector of samples (the samples that make the histogram)
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  properties
    first;
    last;
  ...
  methods
    ...
    function [f,xi] = ksdens(histo)
      [f,xi] = ksdensity(histo.samples);
    end
  end
end
