...
%% mcmc model error
numberOfSamplesTraining = 50;
boundSurrogate1 = -4;
boundSurrogate2 = 0;
modelerr = @(theta) E(boundSurrogate1, boundSurrogate2 ...
	           ,theta,ngaussians,parametersDimension,numberOfSamplesTraining,numberOfSamplesTrueDensity ...
                                         ,trueDensitySamples,MMDtrueDensitySamples,kernelSigmaSquare);
modelSigma2 = 0.003;
modelPriorSigma2S20 = modelSigma2;
modelPriorSigma2N0  = 35;
%% Parameters
...
for j=1:ngaussians
  ...
  xlabel('iteration','FontName',fname,'fontsize',fsize);
  ylabel('mean value','FontName',fname,'fontsize',fsize);
  ha=gca;set(ha,'linewidth',1.5,'FontName',fname,'FontSize',fsize,'Box','on');
  hold off;
end
