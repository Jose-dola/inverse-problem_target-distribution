...
numberOfSamplesTrueDensity = 1e3;
...
%% mcmc model error
numberOfSamplesTraining = 1e3;
modelerr = @(theta) E(theta,ngaussians,parametersDimension,numberOfSamplesTraining,numberOfSamplesTrueDensity ...
                                         ,trueDensitySamples,MMDtrueDensitySamples,kernelSigmaSquare);
modelSigma2 = 0.0007;
modelPriorSigma2S20 = modelSigma2;
modelPriorSigma2N0  = 9*1e3;
%% Parameters
